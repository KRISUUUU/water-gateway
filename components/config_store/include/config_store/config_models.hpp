...
struct AuthConfig {
    // V1 format: "salt_hex(32):hash_hex(64)"  = 97 chars + '\0'  (SHA-256, legacy)
    // V2 format: "pbkdf2$iter$salt_hex(32)$dk_hex(64)" <= 110 chars + '\0'
    char admin_password_hash[128]; // SECRET — enlarged in config v2
