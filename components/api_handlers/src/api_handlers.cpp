...
esp_err_t handle_diagnostics_radio(httpd_req_t*); esp_err_t handle_diagnostics_mqtt(httpd_req_t*); esp_err_t handle_diagnostics_prios(httpd_req_t*); esp_err_t handle_diagnostics_prios_export(httpd_req_t*);
